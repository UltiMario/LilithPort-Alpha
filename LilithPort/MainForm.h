		...
		MainForm(void)
		{
			...
			if(MTOPTION.BOOKMARK_COUNT > 0) {
				for(UINT i=0;i < MTOPTION.BOOKMARK_COUNT;i++) {
					...
					toolStripMenuItemDelBookMark->Text = L"好elete";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->toolStripMenuItemExit->Text = L"拾xit";
			...
			this->RestartToolStripMenuItem->Text = L"抗estart";
			...
			this->toolStripMenuItemSetting->Text = L"心ettings";
...
#pragma endregion
	...
	protected:
		...
		void ReloadList(){
			...
			WriteMessage("メンバーリストを更新しました。(連続しての更新はサーバに負荷がかかるため、注意してください。)\n", SystemMessageColor);
		}
